# Generated by Skyramp v1.3.18 on 2026-04-24 18:58:16.705203984 +0000 UTC m=+78.759472745
# Command: skyramp generate integration rest \
# 		--auth-type Bearer \
# 		--framework pytest \
# 		--language python \
# 		--output order_cancelled_status_workflow_integration_test.py \
# 		--output-dir /home/runner/work/ebikes-lwc/ebikes-lwc/tests \
# 		--overwrite \
# 		--runtime local \
# 		--trace /home/runner/work/ebikes-lwc/ebikes-lwc/tests/scenario_order-cancelled-status-workflow.json
...
def test_integration():
    ...
    assert skyramp.get_response_value(orders_PUT_response, "Status__c") == "Cancelled"
    ...
    assert skyramp.get_response_value(orders_GET_response, "Status__c") == "Cancelled"
