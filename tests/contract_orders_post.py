...
def test_orders_batch_post():
    ...
    assert skyramp.get_response_value(orders_batch_POST_response, "0.Name") is not None
    ...
    assert skyramp.get_response_value(orders_batch_POST_response, "0.CreatedDate") is not None
    ...
    assert skyramp.get_response_value(orders_batch_POST_response, "1.Account__c") == "001g800000C3eLNAAZ"
    assert skyramp.get_response_value(orders_batch_POST_response, "1.LastModifiedDate") is not None
