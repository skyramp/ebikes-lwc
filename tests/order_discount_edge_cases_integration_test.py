# Generated by Skyramp v1.3.18 on 2026-04-24 13:54:07.075588244 +0000 UTC m=+26.883924583
# Command: skyramp generate integration rest \
# 		--auth-type Bearer \
# 		--framework pytest \
# 		--language python \
# 		--output order_discount_edge_cases_integration_test.py \
# 		--output-dir /home/runner/work/ebikes-lwc/ebikes-lwc/tests \
# 		--overwrite \
# 		--runtime local \
# 		--trace /home/runner/work/ebikes-lwc/ebikes-lwc/tests/scenario_order-discount-edge-cases.json
...
def test_integration():
    ...
    assert skyramp.get_response_value(endpoint_1_POST_response, "Discount_Percent__c") == -10
    ...
    assert skyramp.get_response_value(orders_GET_response, "Discount_Percent__c") == -10
