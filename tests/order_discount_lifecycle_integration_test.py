# Generated by Skyramp v1.3.18 on 2026-04-24 18:58:03.199696778 +0000 UTC m=+183.090762321
# Command: skyramp generate integration rest \
# 		--auth-type Bearer \
# 		--framework pytest \
# 		--language python \
# 		--output order_discount_lifecycle_integration_test.py \
# 		--output-dir /home/runner/work/ebikes-lwc/ebikes-lwc/tests \
# 		--overwrite \
# 		--runtime local \
# 		--trace /home/runner/work/ebikes-lwc/ebikes-lwc/tests/scenario_order-discount-lifecycle.json
...
def test_integration():
    ...
    assert skyramp.get_response_value(endpoint_1_POST_response, "Discount_Percent__c") == 20
    ...
    assert skyramp.get_response_value(orders_GET_response, "Discount_Percent__c") == 20

    # Request Body
    orders_PUT_request_body = r'''{
        "Discount_Percent__c": 35,
    ...
    assert skyramp.get_response_value(orders_PUT_response, "Discount_Percent__c") == 35
    ...
    assert skyramp.get_response_value(orders_GET_1_response, "Discount_Percent__c") == 35
